...
import {Copy, Eye, EyeOff, Globe, Star} from 'lucide-react';
        ...
        <div className="p-4 space-y-3">
            {favorites.map(item => (
                ...
                >
                    <div className="flex items-start gap-3">
                        {/* 图标 */}
                        <div
                            className="w-10 h-10 rounded-lg bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center text-white shadow-md">
            ...
            {favorites.length === 0 && (
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">暂无收藏项目</p>
                    <p className="text-sm text-gray-500 mt-1">将常用的登录信息添加到收藏夹</p>
                </div>
            )}
        </div>
    );
