...
export const AddItemModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md max-h-[90vh] overflow-y-auto bg-white dark:bg-gray-800 rounded-xl shadow-2xl">
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">添加密码项</h2>
          <button
            onClick={handleClose}
        ...
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-4 gap-2">
            ...
            >
              <Key className={`w-6 h-6 ${itemType === ItemType.Login ? 'text-blue-500' : 'text-gray-400'}`} />
            ...
            >
              <CreditCard className={`w-6 h-6 ${itemType === ItemType.Card ? 'text-blue-500' : 'text-gray-400'}`} />
            ...
            >
              <FileText className={`w-6 h-6 ${itemType === ItemType.SecureNote ? 'text-blue-500' : 'text-gray-400'}`} />
