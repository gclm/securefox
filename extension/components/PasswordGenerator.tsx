...
import {clearClipboardAfterDelay, copyToClipboard} from '@/utils/helpers';
...
export const PasswordGenerator: React.FC<PasswordGeneratorProps> = ({onUsePassword}) => {
    ...
    return (
        <div className="w-full space-y-4 p-4 pb-20">
            {!onUsePassword && (
                <div className="mb-2">
                    <h3 className="text-base font-semibold text-gray-800">密码生成器</h3>
                    <p className="text-xs text-gray-500">为您的账户创建强大且独一无二的密码</p>
                </div>
            )}
