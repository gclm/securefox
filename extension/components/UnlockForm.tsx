        ...
        <div className="w-full h-full flex flex-col bg-gradient-to-b from-white to-gray-50">
            <div className="flex-1 flex flex-col items-center justify-center px-6">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-center text-gray-900">SecureFox</h1>
                        ...
                        <div>
                            <div className="relative">
                                <Input
                                    ...
                                    className={`h-12 pl-4 pr-12 text-base bg-white border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                        ...
                        {isLocked && (
                            <div className="flex items-center gap-2 p-3 rounded-xl bg-red-50 border border-red-200">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-red-600 mt-0.5">请稍后再试或联系管理员</p>
                                </div>
                            </div>
                        )}
